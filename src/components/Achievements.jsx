          ...
          >
            <div className="flex items-center justify-between mb-7">
              ...
              <motion.svg
                ...
                whileHover={{ rotate: 72 }} transition={{ duration: 0.5 }}
                className="opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              >
                <polygon
                  points="12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"
                  stroke="#c9a84c" strokeWidth="1" fill="rgba(201,168,76,0.1)"
                />
              </motion.svg>
            </div>

            <h3 className="font-heading italic text-2xl md:text-3xl mb-3 text-white/80
            ...
            <p className="text-white/30 text-[13px] md:text-sm font-mono leading-relaxed
